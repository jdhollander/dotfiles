...
let colors_name = "jonscolors"

let s:grey_blue = '#468197'
let s:light_grey_blue = '#468197'
let s:dark_grey_blue = '#7cafc2'
let s:mid_grey_blue = '#86c1b9'
let s:beige = '#'
let s:light_orange = '#f7ca88'
let s:yellow = '#b98840'
let s:violet = '#ba8baf'
let s:green = '#a1b56c'
let s:lightgreen = '#89a244'
let s:red = '#832a27'
let s:cyan = '#508a82'
let s:darkgrey = '#585858'
let s:grey = '#989898'
let s:lightgrey = '#d8d8d8'
let s:white = '#f8f8f8'
